...
import com.example.moviesapp.model.UserPreferences
...
class DataStoreManager (private val context: Context) {
    ...
    suspend fun setUser(id: String,
        ...
        context.loginDataStore.edit { preferences ->
            ...
            preferences[CONFIRM_KEY] = confirm
    ...
    companion object {
        ...
        private val CONFIRM_KEY = stringPreferencesKey("confirm_key")
